...
global $nombres, $email, $fyh_creacion, $rol, $productos_datos, $email_sesion, $URL, $codigo, $categoria, $nombre, $descripcion, $stock, $stock_minimo, $stock_maximo, $precio_compra, $precio_venta, $fecha_ingreso, $imagen, $id_producto;
