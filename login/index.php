...
<div class="login-box">
    ...
    <center>
        <img src="https://img.freepik.com/vector-gratis/gerentes-startups-que-presentan-analizan-tabla-crecimiento-ventas-grupo-trabajadores-monton-dinero-efectivo-cohetes-diagramas-barras-flecha-monton-dinero_74855-14166.jpg?" alt="" width="300px">
    </center>
    <br>
    <div class="card card-outline card-primary">
        <div class="card-header text-center">
            <a href="../public/templeates/AdminLTE-3.2.0/index2.html" class="h1"><b>Sistema </b>VENTAS</a>
        </div>
        <div class="card-body">
