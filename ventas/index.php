                                                ...
                                                <td>
                                                    <center>
                                                        <div class="btn-group">
                                                            ...
                                                            <a href="factura.php?id=<?= $id_venta; ?>&nro_venta=<?= $nro_venta; ?>" target="_blank" type="button" class="btn btn-secondary btn-sm"><i class="fa fa-print"></i></a>
                                                        </div>
                                                    </center>
                                                </td>
                                            </tr>
